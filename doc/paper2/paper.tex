...
% TODO: introduce \textsf{DPMC} \citep{DBLP:conf/cp/DudekPV20}
...
% TODO: tackle a comparable problem, but their encoding was never implemented or
% empirically tested (i.e., the implementation is left as future work)
% \citep{DBLP:conf/scai/VomlelT13}

% TODO: introduce \texttt{bklm16} \citep{DBLP:conf/ecai/BartKLM16}
...
\begin{table}
  ...
  \begin{tabular}{lrrr}
    ...
    $\textsf{Ace} + \texttt{cd06}$ & \textcolor{red}{34} & 218 & \textcolor{red}{1259} \\
    $\textsf{Ace} + \texttt{d02}$ & \textcolor{gray}{0} & 46 & 993 \\
    $\textsf{ADDMC} + \texttt{bklm16}$ & \textcolor{gray}{0} & 29 & \textcolor{blue}{617} \\
    $\textsf{ADDMC} + \texttt{cw}$ & 14 & \textcolor{red}{770} & 919 \\
...
\begin{figure*}[t]
  \centering
  \input{melt.tex}%
  \caption{TODO: describe this in the text}
  \label{fig:melted}
\end{figure*}
