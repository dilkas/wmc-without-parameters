...
% TODO: The notation for a->b and b->a is backwards.
\begin{table*}
...
% TODO: maybe: it would be easier to talk about pseudo-Boolean functions
% instead, but maybe it's not necessary.
...
% TODO: Perhaps make explicit that the additional clauses added for multi-valued
% variables are mutual exclusivity constraints, by name dropping this.
...
%\begin{figure*}[t] % TODO: maybe not: describe this in the text
%  \centering
%  \input{melt.tex}%
...
network. % TODO: this should be updated
...
\Cref{fig:cumulative} shows that \texttt{cd05} and
...
% TODO: maybe: emphasise that BN encodings have never been compared w.r.t. time
% before
% TODO: the claim about this being applicable to other algorithms is a bit too
% optimistic (especially for the abstract)
% TODO: mention the Chavira & Darwiche "Compiling Bayesian Networks Using
% Variable Elimination" paper
% TODO: also mention the Gogate UAI 2010 paper
