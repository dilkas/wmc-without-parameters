...
% TODO: maybe I should rotate the cumulative plot
% TODO: read 'Preparing the submission materials' (code: dilkas_167)
% TODO: update the abstract during submission
...
\author{\href{mailto:p.dilkas@sms.ed.ac.uk}{Paulius~Dilkas}}
\author{\href{mailto:vaishak@ed.ac.uk}{Vaishak~Belle}}
\affil{%
...
% I could also mention DPMC vs ADDMC and pseudo-Boolean functions
