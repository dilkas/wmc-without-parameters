...
% TODO: Now say that our work is similar: it introduces a new representation
% that is more appropriate for algorithms such as DPMC. Stress that all initial
% pseudo-Boolean functions have two values.
...
\item How many times am I faster than old cd06 and new bklm16? Perhaps add other
  numbers as well.
\end{itemize}
% TODO: define binary = 2 values per variable (or states per node?)
% reuse this term where I'm referring to two values
