...
\end{proposition}
% It’s a bit strange to say same answer, when you don’t precisely refer to
...
% If it is the case that you cannot include the proofs in line, and indeed
