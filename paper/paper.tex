...
\todo[inline]{Remember that these are upper bounds! Some of these encoding have
  a lot of optimisations that are not captured by three parameters!}

\todo[inline]{Explain why clauses and ADDs are alike.}
