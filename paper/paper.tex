...
\todo[inline]{Describe the algorithm and the CPT functions. In fact, we call
  each CPT function (i.e., a function that represents a CPT) a \emph{conditional
    weight function} (and this is more of a semantic rather than practical
  distinction).}
