...
% TODO: (needed to follow formatting requirements)
% 1. Remove the \input command.
% 2. R should compile the tex files to be standalone.
% 3. Edit the tex files to replace RGB colours with CMYK.
% 4. Compile the tex files to PDFs.
% 5. Include the PDFs (look up how to do that in the formatting guidelines).
