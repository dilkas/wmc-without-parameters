...
%2. State the problem you tackle.
  % Not using additional literals
%3. Summarize (in one sentence) why nobody else has adequately answered the research question yet.
  % The dominant definition of WMC severely restricts what measures can be represented
%4. Explain, in one sentence, how you tackled the research question.
  % Defining weights akin to conditional probabilities.
%5. In one sentence, how did you go about doing the research that follows from your big idea.
  % ADDMC + Bayesian networks
%6. As a single sentence, what’s the key impact of your research?
  % Big improvements in inference speed that can be applied to other algorithms
...
of functions on Boolean algebras and various operations on those functions. In
\cref{sec:wmc_as_measure}, WMC is introduced as the problem of computing the
value of a measure on a Boolean algebra. We show that not all measures can be
...
significantly improved inference speed on most instances, often by one or two
orders of magnitude. We explain the performance benefits by showing how the new
...
Boolean algebra by $0.5$, but the number of atoms being considered is halved. To
