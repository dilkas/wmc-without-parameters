...
\begin{itemize}
\item Describe \cref{tbl:notation_example} as an example.
\item[F] Feedback: explain with examples: models $=$ atoms of algebra, formulas
  $=$ all elements.
\end{itemize}
...
\todo[inline]{Include this in the example.}
...
\]
In our algebraic formulation, this can be computed...
