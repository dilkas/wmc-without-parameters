...
% Contributions:
% 1. A generalisation of WMC to Boolean algebras. We show how WMC makes
% independence assumptions and how we can make some but not all literals
% independent.
% 1.5. We show how the lifted inference techniques stem from the underlying
% algebraic structure.
% 1.6. Do we add more inference rules?
...
\begin{itemize}
\item Infinite BAs.
  % TODO: Feedback 2: understanding this is the key for formulating the
  % relevance/significance of this work
  \begin{itemize}
...
% TODO: Feedback 2: I did a high level read to get the big picture but found
...
% TODO: Feedback 2: Result #1: What are the conditions under which WMC defines a
% measure as introduced above? [Non-negativity should be enough so this is not a
% result.]
...
% TODO: Feedback 2: I look the significance of the below results. Proving
...
% TODO: Feedback 2: Result #2: WMC c measures. That is, WMC wight weights on
% literals is less expressive than (a) WMC with weights on models is less
% expressive than (b) measures on Boolean algebras?  Results only link at (a).
% Is (c) true? Proof? [It could cover (some sort of) infinite cases...]
...
% TODO: Feedback 2: You need to explain the significance of this result. Result
% #3: Augmented approach recovers the expressivity of (b). [This is a result,
...
\bibliography{paper}
% TODO: curly brackets or parentheses for families? Maybe curly brackets
