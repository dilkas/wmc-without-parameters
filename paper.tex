...
\item Encodings:
  \begin{itemize}
  \item Darwiche \cite{DBLP:conf/kr/Darwiche02}
  \item \hl{Sang et al.} \cite{DBLP:conf/aaai/SangBK05}
  \item \hl{mine}
  \end{itemize}
\item Datasets\footnote{There might be more at
  ...
  \item binary Bayesian networks from Sang et
    ...
    \item Deterministic quick medical reference.
    \end{itemize}
  ...
  \item non-binary Bayesian networks?
