...
% TODO: 'we extend the Gaifman graph to add edges when two one variables occur
% in the same CPT (including the edge a~b when the CPT is P(A|B))'

Extra benefit: one does not need to come up with a way to turn some probability
