...
% TODO: maybe I can rephrase this into a stronger result specifically about
% a /\ ~p. Do I even want to do that?
\begin{lemma}
...
% TODO: how can WMC compute something in the quotient algebra?
% 1) The highlighted lemma from my notes.
% 2) the results about <=
% TODO: prove that the two ways to compute the probability give the same answer,
% i.e., how B(Delta) = B(L)/(not Delta).
% TODO: need an example of how we can compute probabilities in the quotient
% algebra.
